...
\begin{center}
    {\LARGE \textbf{Assignment 01: Time Domain Response of RLC Circuits}}\\
    \vspace{0.3cm}
...
\subsection*{Useful Differential Equation Solutions}
...
\begin{itemize}
    ...
    \]
    where $s_{1,2} = -\alpha \pm \sqrt{\alpha^2 - \omega_0^2}$ (both real, negative)
...
\noindent The switch has been open for a long time. The capacitor is initially uncharged $v_{\text{out}}(0^-) = 0$ and $V_s = 1V$. At $t = 0$, the switch closes. Sketch $v_{\text{out}}(t)$.
