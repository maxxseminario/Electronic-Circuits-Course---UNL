...
\item \textbf{[12.5 points] Phasor Conversions and Operations}
...
\item \textbf{[12.5 points] Series-Parallel LC Combination}
...
\textbf{(a)} Calculate the impedance of the parallel LC combination at $f = 796$ Hz. Express in both rectangular and polar forms.

\vspace{4cm}

\textbf{(b)} Calculate the total impedance $\mathbf{Z}_{tot}$ at $f = 796$ Hz. Express your answer in both rectangular and polar forms.
...
\item \textbf{[12.5 points] Series-Parallel RL Circuit Analysis}
...
\begin{circuitikz}[american, scale=1]
    ...
    \draw (5.5,3) to[L, l=$L_2$] (7.5,3);
    \draw (7.5,3) to[short] (7.5,0);
    \draw (7.5,0) to[short] (4.5,0);
    \draw (4.5,0) to[short] (2.5,0);
    \draw (2.5,0) to[short] (0,0);
\end{circuitikz}
\end{center}

\noindent The circuit consists of $R_1$ in series with a parallel combination of $R_2$ and $L_1$, all in series with $L_2$.
...
\item \textbf{[12.5 points] Multiple Capacitor Circuit}
...
\item \textbf{[12.5 points] Series-Parallel RC Network with Load}
...
\textbf{(a)} Calculate the impedances of $C_1$ and $C_2$ at $\omega = 8000$ rad/s, then find the equivalent impedance of the parallel capacitor combination.
...
\item \textbf{[12.5 points] Complex Power Analysis}
...
\item \textbf{[12.5 points] Complex RLC Network with Series-Parallel Combination}
...
\item \textbf{[12.5 points] Multi-Inductor Parallel-Series Circuit}
