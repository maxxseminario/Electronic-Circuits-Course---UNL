...
With the circuit from Part 2, connect various load resistors $R_L$ from the output to ground. Use the following values:  10 k$\Omega$, 2.2 k$\Omega$, and 470 $\Omega$.
