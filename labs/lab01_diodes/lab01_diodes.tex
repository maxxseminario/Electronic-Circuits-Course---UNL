...
.8 V$. Very little current flows until the diode voltage reaches approximately 0.5 to 0.6 V, after which the current increases exponentially. Exercise caution not to exceed a current of approximately 20 mA for silicon diodes, as excessive current can cause damage.  If the diode is heating up noticeably, reduce the current immediately.\\
