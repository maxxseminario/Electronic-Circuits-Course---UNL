...
\begin{frame}{Next Lecture: The pn Junction}
    
    \textbf{Coming Up}:
    \begin{itemize}
        \item What happens when p-type and n-type meet?
        \item Depletion region formation
        \item Built-in potential
        \item Forward and reverse bias
        \item V-I characteristics of diodes
        \item Diode circuit applications
    \end{itemize}
    ...
    \begin{tikzpicture}[scale=0.7]
        % p-type region
        \draw[thick, fill=orange!20] (0,0) rectangle (3,2);
        \node[font=\large] at (1.5,1) {p-type};
        
        % n-type region
        \draw[thick, fill=green!20] (3,0) rectangle (6,2);
        \node[font=\large] at (4.5,1) {n-type};
        
        % Junction line
        \draw[ultra thick, red] (3,0) -- (3,2);
        
        \node[above, font=\small] at (3,2.2) {pn Junction};
        
    \end{tikzpicture}
    \end{center}
    
    \textbf{Prepare}: Review band diagrams and carrier concentrations
