...
\begin{frame}{Input and Output Impedances}
    ...
    \column{0.48\textwidth}
        ...
        \begin{circuitikz}[scale=0.8]
            ...
            \draw[->, red, very thick] (2.0,2.3) -- (2.5,2.3) node[above] {$i = 0$};
    ...
    \column{0.48\textwidth}
        ...
        \begin{circuitikz}[scale=1.0]
            ...
            \draw (-1,0) to[sV, l^=$A v_{in}$] (-1,2);
            \draw (-1,2) -- (1,2);
            \draw (-1,0) -- (1,0);
            
            % Load
            \draw (1,2) to[R, l_=$R_L$, v^=$v_o$] (1,0);
...
\begin{frame}{Practice Problem 2}
    ...
    \end{circuitikz}
    \caption{Internal op-amp model: $G_m = 10$ mA/V, $R = 10$ k$\Omega$}
    \end{figure}

    \vspace{0.2cm}

    \textbf{Find}: Express $v_x$ as a function of $v_1$ and $v_2$. 
