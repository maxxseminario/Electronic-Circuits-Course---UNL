...
\begin{frame}{Bridge Rectifier with Filter}
    ...
    \column{0.48\textwidth}
        ...
        \begin{circuitikz}[american, scale=0.8]
            ...
            % Load and capacitor in parallel between top and bottom
            \draw (1.5,1.5) to[short, *-] (4,1.5);
            \draw (4,1.5) to[R, l_=$R_L$] (4,-1.5);
            \draw (4,1.5) to[short] (5,1.5)
                  to[C, l=$C$] (5,-1.5)
                  to[short] (4,-1.5);
            \draw (4,-1.5) to[short, -*] (1.5,-1.5);
    ...
    \column{0.48\textwidth}
        ...
        \begin{align*}
            V_r &= \frac{17}{2 \times 60 \times 2200 \times 470 \times 10^{-6}} = 0.137 \text{ V}
        \end{align*}
