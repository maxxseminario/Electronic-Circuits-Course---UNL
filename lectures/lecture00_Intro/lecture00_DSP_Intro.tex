...
% %%
\title[ECEN 463/863]{Introduction to Digital Signal Processing}
...
\begin{figure}
	\centering
	\resizebox{0.5\linewidth}{!}{\input{figs/channel_no_eq.tex}}
\end{figure}
\end{block}
...
\begin{frame}{Digital processing of analog signals}
	...
	\begin{block}{Digital signal processor}
		\begin{itemize} \itemsep 0pt
			...
			\item May be implemented on PCs with 64-bit floating-point precision, or on ASICs with limited arithmetic precision.
		\end{itemize}
	\end{block}
	\vspace{-0.3cm}
...
\begin{itemize}
	...
	\item Late submissions will be not accepted. If you need an extension, please contact the instructor in advance.
\end{itemize}
